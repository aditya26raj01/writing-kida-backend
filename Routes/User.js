...
router.post(
  ...
  [
    ...
    body("password")
      ...
      .withMessage(
        "Password must contain minimum 6 characters, at least one uppercase letter, one lowercase letter, one number and one special character"
      ),
  ],
  signup
);
...
router.post(
  ...
  [
    body("title")
      .isLength({ min: 20 })
      .withMessage("Min 20 Max 50 Characters - Title"),
    body("tag").notEmpty().withMessage("Enter Valid Tag"),
    body("description")
      .isLength({ min: 20 })
      .withMessage("Min 20 Max 100 Characters - Description"),
    body("content")
      .isLength({ min: 100 })
      .withMessage("Min 100 Characters - Content"),
